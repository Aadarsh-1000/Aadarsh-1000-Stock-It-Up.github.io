(function () {
  // -------- CONFIG --------
  const DISPLAY_TICKER = "TCS";             // Company name to display in tooltip
  const DATA_URL = "/array.json";           // Path to your JSON feed
  ...
  function createChartOnCanvas(canvas) {
    ...
    const cfg = {
      ...
      data: {
        labels: [], datasets: [{
          data: [],
          borderColor: "#11a8caff",
          backgroundColor: "#07bfe81c",
          borderWidth: 2,
          pointRadius: 2,
          pointHoverRadius: 3,
          pointBackgroundColor: "#fff",
          pointBorderColor: "#11a8caff",
          pointBorderWidth: 2,
          tension: 0.1,
          fill: true
        }]
