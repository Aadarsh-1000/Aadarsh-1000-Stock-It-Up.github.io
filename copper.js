(function () {
  // -------- CONFIG --------
  const DISPLAY_TICKER = "HDFCBANK";             // Company name to display in tooltip
  const DATA_URL = "../copper.json";           // Path to your JSON feed
  ...
  function createChartOnCanvas(canvas) {
    ...
    const cfg = {
      ...
      data: {
        labels: [], datasets: [{
          data: [],
          borderColor: "#b313dfff",
          backgroundColor: "#b313df3e",
          borderWidth: 2,
          pointRadius: 2,
          pointHoverRadius: 3,
          pointBackgroundColor: "#fff",
          pointBorderColor: "#b313dfff",
          pointBorderWidth: 2,
          tension: 0.1,
          fill: true
        }]
