(function () {
  // -------- CONFIG --------
  const DISPLAY_TICKER = "BHARTIARTL";             // Company name to display in tooltip
  const DATA_URL = "../bronze.json";           // Path to your JSON feed
  ...
  function createChartOnCanvas(canvas) {
    ...
    const cfg = {
      ...
      data: {
        labels: [], datasets: [{
          data: [],
          borderColor: "#06ee4fff",
          backgroundColor: "#06ee4f19",
          borderWidth: 2,
          pointRadius: 2,
          pointHoverRadius: 3,
          pointBackgroundColor: "#fff",
          pointBorderColor: "#00ff51ff",
          pointBorderWidth: 2,
          tension: 0.1,
          fill: true
        }]
